...
##############################################################################
{
    'name': "Egas correo ventas",

    'summary': """Se enviara un correo electronico cuando se confirme el pedido de ventas""",

    'description': """
        Se enviara un correo electronico cuando se confirme el pedido de ventas
    """,
    ...
    'data': [
        #'templates.xml',
        'views/correo_electronico_view.xml',
